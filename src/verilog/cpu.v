...
assign insert_bubble = next_pc_from_EX_eff 
        | (sram2rf_EX & (rf_wi_EX != 4'b0) & ((rf_ri1_ID == rf_wi_EX) | (rf_ri2_ID == rf_wi_EX))) & rf_wi_EX != 4'b0
        | (csr2rf_EX & (rf_wi_EX != 4'b0) & ((rf_ri1_ID == rf_wi_EX) | (rf_ri2_ID == rf_wi_EX))) & rf_wi_EX != 4'b0
        | (operand_pop_EX & (rf_wi_EX != 4'b0) & ((rf_ri1_ID == rf_wi_EX) | (rf_ri2_ID == rf_wi_EX))) & rf_wi_EX != 4'b0
        | (sram2rf_MEM & (rf_wi_MEM != 4'b0) & ((rf_ri1_ID == rf_wi_MEM) | (rf_ri2_ID == rf_wi_MEM))) & rf_wi_MEM != 4'b0
        | (csr2rf_MEM & (rf_wi_MEM != 4'b0) & ((rf_ri1_ID == rf_wi_MEM) | (rf_ri2_ID == rf_wi_MEM))) & rf_wi_MEM != 4'b0
        | (operand_pop_MEM & (rf_wi_MEM != 4'b0) & ((rf_ri1_ID == rf_wi_MEM) | (rf_ri2_ID == rf_wi_MEM))) & rf_wi_MEM != 4'b0;
