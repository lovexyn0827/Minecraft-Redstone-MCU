...
void build_cond_expr_evaluator(build_ctx_t *ctx, const ast_expr_cond_t *expr,
                               const obj_addr_t *val_dest, FILE *asm_dest) {
}

void build_assign_expr_evaluator(build_ctx_t *ctx, const ast_expr_assign_t *expr,
                                 const obj_addr_t *val_dest, FILE *asm_dest) {
}

void build_call_expr_evaluator(build_ctx_t *ctx, const ast_expr_call_t *expr,
                               const obj_addr_t *val_dest, FILE *asm_dest) {
}

void build_symbol_expr_evaluator(build_ctx_t *ctx, const ast_expr_symbol_t *expr,
                                 const obj_addr_t *val_dest, FILE *asm_dest) {
}

void build_expr_evaluator(build_ctx_t *ctx, const ast_expr_t *expr, const obj_addr_t *val_dest, FILE *asm_dest) {
...
void generate_asm(build_ctx_t *ctx, FILE *asm_dest) {
}
